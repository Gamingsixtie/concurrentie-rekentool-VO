...
const DEMO_PROPOSALS: PriceProposal[] = [
  {
    ...
    evidence_path: null, status: 'open', rejection_reason: null,
  ...
  },
  {
    ...
    evidence_path: '/uploads/jij-korting-mail.pdf', status: 'open', rejection_reason: null,
    submitted_by: 'demo-user', reviewed_by: null, reviewed_at: null,
  ...
  },
  {
    ...
    evidence_path: null, status: 'approved', rejection_reason: null,
  ...
  },
  {
    ...
    evidence_path: null, status: 'rejected', rejection_reason: 'Actieprijs is tijdelijk (geldig t/m april). Reguliere prijs blijft €2,90.',
  ...
  },
  {
    ...
    evidence_path: '/uploads/jij-offerte-marnix.pdf', status: 'open', rejection_reason: null,
    submitted_by: 'demo-user', reviewed_by: null, reviewed_at: null,
